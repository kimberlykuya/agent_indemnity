...
PROMPTS = [
    dict(id="01_general_clean",
         ...
         expect_type=AnomalyType.NONE, expect_slash=None),
    ...
    dict(id="04_jailbreak",
         ...
         expect_type=AnomalyType.JAILBREAK, expect_slash=False),
    dict(id="05_refund_abuse",
         ...
         expect_type=AnomalyType.UNAUTHORIZED_REFUND, expect_slash=True),
